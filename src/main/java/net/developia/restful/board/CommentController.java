...
public class CommentController {
	...
	@PostMapping("/")
	@ResponseBody
	public List<CommentVO> comment_insert(@ModelAttribute CommentVO commentVO, HttpServletRequest request, HttpSession session) {
	...
	@PostMapping("/{com_no}")
	@ResponseBody
	public List<CommentVO> comment_update(@PathVariable long com_no,
	...
	@ResponseBody
	public List<CommentVO> comment_delete(@PathVariable long com_no,
											@ModelAttribute CommentVO commentVO,
											HttpSession session, HttpServletRequest request) throws Exception{
		commentVO.setCom_ip(request.getRemoteAddr());
		commentVO.setUserVO((UserVO)session.getAttribute("userInfo"));
