...
public class UserVO implements Serializable{
	...
	public String toString() {
		return "UserVO [usr_no=" + usr_no + ", usr_id=" + usr_id + ", usr_pw=" + usr_pw + ", usr_name=" + usr_name
				...
				+ ", usr_address_detail=" + usr_address_detail + ", getUsr_no()=" + getUsr_no() + ", getUsr_id()="
				+ getUsr_id() + ", getUsr_pw()=" + getUsr_pw() + ", getUsr_name()=" + getUsr_name() + ", getUsr_info()="
				+ getUsr_info() + ", getUsr_level()=" + getUsr_level() + ", getUsr_status()=" + getUsr_status()
				+ ", getUsr_regdate()=" + getUsr_regdate() + ", getUsr_lastlogin()=" + getUsr_lastlogin()
				+ ", getUsr_logcnt()=" + getUsr_logcnt() + ", getUsr_ip()=" + getUsr_ip() + ", getUsr_zipcode()="
				+ getUsr_zipcode() + ", getUsr_address()=" + getUsr_address() + ", getUsr_address_detail()="
				+ getUsr_address_detail() + ", getClass()=" + getClass() + ", hashCode()=" + hashCode()
